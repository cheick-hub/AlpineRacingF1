...
yaml_file="$script_dir/.docker/docker-compose_fastAPI_dev.yml"

# Afficher le chemin complet vers le fichier YAML
echo_color "34" "Fichier Compose : $yaml_file"

echo_color "34" "docker pull alpineracing.azurecr.io/alr/catana_fastapi:dev"

docker pull alpineracing.azurecr.io/alr/catana_fastapi:dev
